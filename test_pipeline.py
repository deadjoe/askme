...
from askme.core.config import Settings, EmbeddingConfig, RerankConfig
...
""")
    ...
    try:
        ...
        print(f"   ✓ Batch size: {info['batch_size']}, Dimension: {info['embedding_dim']}")
    ...
    try:
        ...
        from askme.api.routes import health, ingest, query, evaluation
    ...
    print("\n📋 Next steps:")
    print("   1. Install and start Milvus: docker-compose -f docker/docker-compose.yaml up -d milvus")
