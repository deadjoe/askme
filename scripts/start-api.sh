...
# All available parameters from codebase analysis (comprehensive list)
...
ALL_PARAM_KEYS=(
    ...
    "ASKME_HYBRID__ENABLE_METADATA_FILTER"

    # Embedding Configuration (Dense - Qwen3)
    ...
    "ASKME_EMBEDDING__POOLING_METHOD"
    "ASKME_EMBEDDING__QUERY_INSTRUCTION"
    "ASKME_EMBEDDING__PASSAGE_INSTRUCTION"

    # Embedding Sparse Configuration (BGE-M3)
    "ASKME_EMBEDDING__SPARSE__ENABLED"
    "ASKME_EMBEDDING__SPARSE__BACKEND"
    "ASKME_EMBEDDING__SPARSE__MODEL"
    "ASKME_EMBEDDING__SPARSE__DIMENSION"
    "ASKME_EMBEDDING__SPARSE__BATCH_SIZE"
    "ASKME_EMBEDDING__SPARSE__QUERY_BATCH_SIZE"
    "ASKME_EMBEDDING__SPARSE__MAX_LENGTH"
    "ASKME_EMBEDDING__SPARSE__USE_FP16"
    ...
    "ASKME_RERANK__LOCAL_MAX_LENGTH"
    "ASKME_RERANK__LOCAL_INSTRUCTION"
    "ASKME_RERANK__LOCAL_USE_FP16"
    "ASKME_RERANK__LOCAL_FLASH_ATTENTION"
    "ASKME_RERANK__TOP_N"
    "ASKME_RERANK__SCORE_THRESHOLD"
    "ASKME_RERANK__ENABLE_CROSS_ENCODER"

    # Query Enhancement Configuration
    "ASKME_ENHANCER__HYDE__ENABLED"
    "ASKME_ENHANCER__HYDE__MODEL"
    "ASKME_ENHANCER__HYDE__PROMPT_TEMPLATE"
    "ASKME_ENHANCER__RAG_FUSION__ENABLED"
    "ASKME_ENHANCER__RAG_FUSION__NUM_QUERIES"
    "ASKME_ENHANCER__RAG_FUSION__RERANK"
    ...
    "ASKME_PERFORMANCE__BATCH__SPARSE_BATCH_SIZE"
    "ASKME_PERFORMANCE__BATCH__QUERY_BATCH_SIZE"
    "ASKME_PERFORMANCE__BATCH__RERANK_BATCH_SIZE"
    "ASKME_PERFORMANCE__BATCH__MAX_CONCURRENT_REQUESTS"
    "ASKME_PERFORMANCE__TIMEOUTS__EMBEDDING_TIMEOUT"
    ...
    "ASKME_LOGGING__FORMAT"
    "ASKME_LOGGING__FILE__ENABLED"
    "ASKME_LOGGING__FILE__PATH"
...
main() {
    ...
    # Suppress SWIG deprecation warnings (from pymilvus/grpcio)
